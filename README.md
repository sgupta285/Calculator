...
*   **Modern UI**: Built with Tailwind CSS and shadcn/ui for a clean and intuitive user experience.
...
Simply open the application in your browser. Click the number buttons to input digits, then select an operator (+, -, *, /), input the second number, and press '=' to see the result. Use 'C' to clear the current input or reset the calculator.
